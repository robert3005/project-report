...
\usepackage{tabularx, alltt, amsmath, multirow, graphicx, url, graphics, caption, natbib, listings, fancyhdr}
...
\begin{figure}[ht!]
  ...
  \caption{Schematic working of Planktonica taken from4 Hinsley \cite{Planktonica}}
...
\begin{lstlisting}[
    ...
    language=python,
    escapechar=!]{Python annotated}
!\colorbox{cython-line-1}{def sumTo(num):}!
    !\colorbox{cython-line-2}{c = 0}!
    !\colorbox{cython-line-3}{for i in range(num + 1):}!
        !\colorbox{cython-line-4}{c = c + i}!
    !\colorbox{cython-line-5}{return c}!
\end{lstlisting}
