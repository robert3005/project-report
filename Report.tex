...
\subsection{Threading}\label{appen-subsec:bench-c++-wrap-multi}
...
\section{C Array}\label{appen-sec:bench-array}
\begin{table}[H]
  \begin{center}
    \begin{tabular}{|c||c||c|c|c|}
    \hline
...
\subsection{Threading}\label{appen-subsec:bench-array-multi}
\begin{table}[H]
  \begin{center}
    \begin{tabular}{|c||c||c|c|c|}
    \hline
