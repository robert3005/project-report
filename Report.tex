...
implementation without GIL and with JIT capabilities. Thus removing the need
...
is not likely to happen without clear need.
...
\todo{copy code snippet from \ref{subsec:cython-code-annot}}
\end{appendices}
